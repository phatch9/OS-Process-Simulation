...
// with leading or trailing whitespace (unlikely) will not work.*/
    ...
    */
    ...
    TODO: Implement
        ...
        Note that a new process will be chosen to run later (via the
    ...
    */
    ...
    TODO: Implement
        ...
        4. Populate the PCB entry obtained in #1
            ...
            b. Set the parent process ID to the process ID of theunning process (use the running process's PCB entry to get this).
    ...
    */
    ...
    2. Use createProgram() to read in the filename specified by argument into the CPU (*cpu.pProgram)
        a. Consider what to do if createProgram fails. 
        I printed an error, incremented the cpu program counter and then returned. 
